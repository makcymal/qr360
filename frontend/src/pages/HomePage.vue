  ...
  <div class="cols-wrapper">
  	...
  	<div class="col center">
  		<div class="cont big dgry-bg">
  			<svg xmlns="http://www.w3.org/2000/svg" fill="#DFE4EA" class="alt" viewBox="0 0 16 16">
  	...
  	<div class="col">
  		<div class="cont sml btm">
  			<a href="/auth" class="btn text sml dgry-bg whit-fn">
  				Авторизация
  			</a>
  		</div>
  		<div class="cont big orng-bg">
  			...
  			<h3 class="text xs pad-top whit-fn">
	  			Созданный у нас QR будет вести на промежуточную страницу, которая направит Вашего клиента туда, куда укажете Вы
  			</h3>
  		</div>
  	</div>
  </div>
